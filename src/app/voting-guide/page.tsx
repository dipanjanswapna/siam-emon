...
const steps = [
    {
        ...
        description: "আপনার জাতীয় পরিচয়পত্র সঙ্গে নিয়ে নির্ধারিত ভোট কেন্দ্রে প্রবেশ করুন। কেন্দ্রের বাইরে থাকা তালিকা থেকে আপনার ভোটার নম্বর ও কক্ষ নম্বর জেনে নিন।",
    },
    {
        icon: FileCheck,
        title: "ধাপ ২: পরিচয় যাচাই ও ব্যালট পেপার সংগ্রহ",
        description: "ভোট কক্ষের দায়িত্বপ্রাপ্ত পোলিং অফিসারের কাছে আপনার পরিচয়পত্র দেখান। তিনি আপনার পরিচয় যাচাই করে আপনাকে একটি ব্যালট পেপার সরবরাহ করবেন।",
    },
    {
        icon: CheckSquare,
        title: "ধাপ ৩: গোপন কক্ষে ভোট প্রদান",
        description: "ব্যালট পেপার নিয়ে গোপন কক্ষে প্রবেশ করুন। আপনার পছন্দের প্রার্থীর নামের পাশে থাকা প্রতীকের উপর ✔ চিহ্ন দিন। ডাঃ মনীষা চক্রবর্ত্তীকে ভোট দিতে 'মই' প্রতীকের উপর ✔ দিন।",
    },
    {
        icon: Vote,
...
const dosAndDonts = {
    dos: [
        "জাতীয় পরিচয়পত্র অবশ্যই সাথে রাখুন।",
        "শান্তিপূর্ণভাবে লাইনে দাঁড়িয়ে আপনার পালা আসার জন্য অপেক্ষা করুন।",
        "ভোট দেওয়ার নিয়মাবলী ভালোভাবে পড়ে নিন।",
        "গোপন কক্ষে একা প্রবেশ করুন।",
        "সঠিকভাবে পছন্দের প্রার্থীর প্রতীকের ঘরে ✔ চিহ্ন দিন।"
    ],
    donts: [
        "ভোট কেন্দ্রে মোবাইল ফোন বা কোনো ইলেকট্রনিক ডিভাইস ব্যবহার করা থেকে বিরত থাকুন।",
                ...
                <Card className="bg-primary/10 border-primary/20">
                     <CardContent className="p-8 text-center">
                        ...
                        <p className="font-body text-lg text-muted-foreground mt-2 max-w-3xl mx-auto">
                            আপনার একটি সঠিক সিদ্ধান্ত দেশের ভবিষ্যৎ নির্ধারণ করবে। আমি আপনাদের পাশে থেকে একটি শোষণমুক্ত, বৈষম্যহীন ও গণতান্ত্রিক বাংলাদেশ গড়ে তুলতে চাই। আপনার মূল্যবান ভোটটি দিয়ে আমাকে সেবা করার সুযোগ দিন।
                        </p>
                    </CardContent>
                </Card>
           </section>
